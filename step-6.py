...
def evaluate_model():
    ...
    # Load artifacts
    try:
        artifacts = joblib.load('cow_id_model.pkl')
    except FileNotFoundError:
        print("Error: 'cow_id_model.pkl' not found. Run step-5.py first.")
        return
    ...
    print("\nEvaluation complete! Report saved to 'final_evaluation_report.txt'")
